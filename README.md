...
The system laverage ultrasonic sensor to detecting river water level and filter the data with five period moving average to avoid misclassification of the state due to momentary data spike.
there are four tasks in the code: 
